...
object manage_wss extends _root_.play.twirl.api.BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,_root_.play.twirl.api.Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with _root_.play.twirl.api.Template0[play.twirl.api.HtmlFormat.Appendable] {
            ...
            <div class="row w-100 d-flex mx-auto justify-content-center pt-2">
                <div class="col-xl-12 cards pb-4">
                    <div style="background-color: #131313" class="card textimg">
                        <img src=""""),_display_(/*9.36*/routes/*9.42*/.Assets.at("../../../../public/images/b.wss.jpg")),format.raw/*9.91*/("""" class="img-fluid" alt="wss">
...
""")))}))
  ...
  def ref: this.type = this
              ...
              /*
                  -- GENERATED --
                  SOURCE: app/views/Management/WaverlySubStation/manage_wss.scala.html
                  HASH: c8353819036a90780c78b79eae5297235a43fae5
                  MATRIX: 1023->1|1177->146|1216->147|1248->153|1288->167|1302->173|1362->213|1735->560|1749->566|1818->615
